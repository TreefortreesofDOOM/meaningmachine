...
export declare class StatisticsApiResponseProcessor {
    v1StatisticsAggregateAppStats(response: ResponseContext): Promise<AppUsageStatsOut>;
    v1StatisticsAggregateEventTypes(response: ResponseContext): Promise<AggregateEventTypesOut>;
